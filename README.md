...
## Usage:
Generate directories COMPRESSED/ and DISK/ in the same directory as the script  
00: Change Email (Line 57) to your comment of choice  
01: Place MP3s in a directory of your choice labeled numerically (01.mp3, 02.mp3, etc)  
